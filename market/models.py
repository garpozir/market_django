...
class mahsool(models.Model):
    ...
    code=models.PositiveIntegerField(verbose_name='کد محصول توسط سیستم تعیین می شود',default=rnd_code,primary_key=True, validators=[MaxValueValidator(99999),MinValueValidator(10000)])
