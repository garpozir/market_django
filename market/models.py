...
class mahsool(models.Model):
    ...
    code=models.PositiveIntegerField(verbose_name='کد محصول توسط سیستم تعیین می شود',default=rnd_code,primary_key=True, validators=[MaxValueValidator(99999)])
    amount=models.PositiveIntegerField(verbose_name='قیمت محصول را به تومان وارد کنید', validators=[MaxValueValidator(999999999)])
    img=models.ImageField(verbose_name='تصویر محصول را انتخاب کنید')
